...
$comment = getCommentByCommentId($database, $commentId);
$replies = getReplysByCommentId($database, $commentId);
...
<main>
    ...
    <section class="comments">
        <h1>On: <a href="comments.php?postId=<?= $postId; ?>"><?= $postTitle; ?></a></h1>
        <article class="comment" id="<?= $comment['id'] ?>">
            <div class="comment-top">
                <p>Comment by <a href="profile.php?userId=<?= $comment['by_user_id']; ?>"> <?= $comment['username']; ?> </a></p>
